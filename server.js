...
// using the cors middleware - FIXED VERSION
const corsOptions = {
  origin: [
    'http://localhost:5173',
    'http://localhost:5174',
    'http://localhost:4173',
    'http://localhost:4174', 
    'https://itsam-frontend.vercel.app',  // Removed trailing slash
    'https://itsam-backend.onrender.com',
    'http://localhost:4175',
    'http://localhost:4176',
    'http://localhost:4177',
    'http://localhost:4178',
  ...
  optionsSuccessStatus: 200,
  credentials: true  // Added for cookie/auth header support
};
app.use(cors(corsOptions))
